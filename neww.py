...
# ----------------- DEVELOPER -----------------
    ...
    <div class="card">
    👩‍🎓 **Name:** Agastyaan <br>
    🎓 **Course:** [BCA/MCA/MBA/CS/IT] <br>
    🏫 **Institute:** Your College Name <br>
    📧 **Email:** your.email@example.com <br>
    🌐 **Portfolio:** your-portfolio-link <br><br>
    🎨 <span class="brand">Design by Agastyaan</span>
    </div>
    """, unsafe_allow_html=True)

# ----------------- Footer -----------------
st.markdown("<footer>© 2025 3D QR Code Generator Project | <span class='brand'>Design by Agastyaan</span> | Made with ❤️ in Python & Streamlit</footer>", unsafe_allow_html=True)
